...
const ACCOUNT_ENDPOINTS = {
    ...
    guardianAttachSubscription(subscriptionId, username) {
        return {
...
export class AccountClient extends Client {
    ...
    */
    ...
    guardianAttachSubscription(subscriptionId, username, token) {
        const endpoint = this.getEndpoint('guardianAttachSubscription', subscriptionId, username);
        if (token) {
            endpoint.headers.append('Authorization', `Bearer ${token}`);
        }

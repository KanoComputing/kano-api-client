...
const ACCOUNT_ENDPOINTS = {
    ...
    guardianAttachSubscription(subscriptionId, userid, prevUserid) {
        return {
            path: '/guardian/attachSubscription',
            method: 'PUT',
            body: JSON.stringify({ subscriptionId, userid, prevUserid }),
            responseType: 'text',
        };
    },
    getSubscriptionById(subscriptionId) {
        return {
            path: `/club/checkout/subscription/${subscriptionId}`,
            method: 'GET',
            responseType: 'json',
        };
    },
    attachUserToSubscription(subscriptionId, userId) {
        return {
            path: `/club/checkout/subscription/${subscriptionId}/user`,
            method: 'POST',
...
export class AccountClient extends Client {
    ...
    */
    ...
    guardianAttachSubscription(subscriptionId, userid, token, prevUserid) {
        const endpoint = this.getEndpoint('guardianAttachSubscription', subscriptionId, userid, prevUserid);
        if (token) {
            endpoint.headers.append('Authorization', `Bearer ${token}`);
        }
    ...
    getSubscriptionById(subscriptionId) {
        const endpoint = this.getEndpoint('getSubscriptionById', subscriptionId);
        return this.fetch(endpoint)
            .then(res => res.data)
            .then(data => this.afterDataProcessed(endpoint, data))
    ...
    attachUserToSubscription(subscriptionId, userId) {
        const endpoint = this.getEndpoint('attachUserToSubscription', subscriptionId, userId);
        return this.fetch(endpoint)
